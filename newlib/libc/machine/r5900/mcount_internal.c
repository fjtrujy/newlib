...
/* <kernel.h> from ps2sdk*/
int EnableIntc(int intc);
int AddIntcHandler2(int cause, int(*handler_func)(int cause, void* arg, void* addr), int next, void* arg);
#define ExitHandler() __asm__ volatile("sync\nei\n")

/* Internal */
#ifndef GMON_OUT
#define GMON_OUT "host:gmon.out"
#endif
